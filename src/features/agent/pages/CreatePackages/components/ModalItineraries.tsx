...
const ModalItineraries = (props: ModalProps) => {
  ...
  const arrayGenerator = () => {
    let array = [];
    array.push({day: '', title: '', description: '', facilities: []});
          ...
          <View style={styles.modalHeaders}>
            <View style={styles.subHeaderLeft}>
              <Text
                ...
                content={{id: 'Itinerary', en: 'Itinerary'}}
              />
            </View>
                ...
                <View key={i} style={styles.containSection}>
                  <View style={styles.marginTop10}>
                    <InputText
                      ...
                      placeholder="Day"
                      onChangeText={(text: any) => onSetData(i, 'day', text)}
...
export default ModalItineraries;
